...
# ---------- GLOBAL CSS & BACKGROUND LOADER ----------
st.markdown("""<style>
    .stApp { background-color: #0f0f1a; color: #e2e8f0; font-family: sans-serif; }
    h1, h2, h3, h4 { color: #6366f1 !important; font-weight: 600 !important; }
    p, span, li { color: #cbd5e1 !important; font-size: 16px; }
    a { color: #38bdf8 !important; text-decoration: none !important; font-weight: 500; }
...
# ---------- HERO SECTION ----------
st.markdown(f"""<style>
.hero {{ {bg_style} background-size: cover; background-position: center; padding: 140px 40px; border-radius: 20px; text-align: center; color: white; box-shadow: 0 10px 30px rgba(0,0,0,0.5); border: 1px solid rgba(255,255,255,0.05); }}
.hero h1 {{ font-size: 55px !important; margin-bottom: 12px; color: #ffffff !important; font-weight: 800 !important; text-shadow: 2px 2px 10px rgba(0,0,0,0.6); }}
.hero h3 {{ font-size: 24px !important; font-weight: 300 !important; color: #cbd5e1 !important; text-shadow: 1px 1px 5px rgba(0,0,0,0.5); }}
</style>
<div class="hero">
    <h1>Roshan</h1>
...
# ---------- SKILLS ----------
st.header("Skills")
st.markdown("""<div style="display: flex; flex-wrap: wrap; gap: 15px;">
    ...
    <div style="background-color: #1e1e30; padding: 12px 25px; border-radius: 10px; border: 1px solid rgba(255,255,255,0.05); font
